...
<div class="card">
	<div class="card-header">
		<div class="row">
			<div class="col col-md-6"><b>Contratos</b></div>
			<div class="col col-md-6">
				<a href="{{ route('contratos.create') }}" class="btn btn-success btn-sm float-end">Add</a>
			</div>
		</div>
	</div>
    <div>
					...
					<tr>
						...
						<td>
							<form method="post" action="{{ route('contratos.destroy', $row->id) }}">
								@csrf
								@method('DELETE')
								<a href="{{ route('contratos.show', $row->id) }}" class="btn btn-primary btn-sm">View</a>
								<a href="{{ route('contratos.edit', $row->id) }}" class="btn btn-warning btn-sm">Edit</a>
